...
require.config({
    ...
    // region REQUIRE MODULES PATHS
    {
        ...
        "picomatch": "third/regex/picomatch/picomatch",
        ...
        "superjson": "third/polyfill/es5/json/superjson/superjson",
        ...
        "url-polyfill": "third/dom/url-polyfill/url-polyfill",
        ...
        "_exports": "third/require/exports/_exports",
        ...
        "Context": "packages/xjsfl/Context/src/Context/Context",
        ...
        "@polyfills/symbol-dispose": "packages/polyfills/symbol-dispose/out/symbol-dispose",
