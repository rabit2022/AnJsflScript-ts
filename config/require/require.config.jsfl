...
require.config({
    ...
    // region REQUIRE MODULES PATHS
    {
        ...
        "test1": "third/regexp/xregexp/test/test1",
        ...
        "test": "third/console/stack/error-stack-parser-3.0.0/test/test",
        "test2": "third/console/stack/error-stack-parser-3.0.0/test/test2",
        "test3": "third/console/stack/error-stack-parser-3.0.0/test/test3",
        "test4": "third/console/stack/error-stack-parser-3.0.0/test/test4",
        "test45": "third/console/stack/error-stack-parser-3.0.0/test/test45",
