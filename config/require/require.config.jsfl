...
require.config({
    ...
    // region REQUIRE MODULES PATHS
    {
        ...
        "xpath": "third/polyfill/xml/xpath-0.0.34/xpath",
        "xmldom": "third/polyfill/xml/xmldom-0.6.0/xmldom",
        "fast-xml-parser": "third/polyfill/xml/fast-xml-parser-5.0.9/fast-xml-parser",
        ...
        "tape": "third/cannotRun/tape/tape",
        "@formatjs/intl": "third/cannotRun/intl-formatjs/polyfill-intl",
