(function() {
    ...
    window.AnJsflScript.app = {
        platform: PLATFORM_CODE, version: VERSION_NUMBER, name: VERSION_NAME, os: {
            mac: PLATFORM_CODE === "mac", win: PLATFORM_CODE === "win"
        }
    };

    var cwd = window.AnJsflScript.$ProjectFileDir$;
    window.AnJsflScript.folders = {
        AnJsflScript: cwd, // core: cwd + 'core/',
        // modules: cwd + 'modules/',
        // user: cwd + 'user/',
        ...
        "@console.stack": cwd + "/packages/dom/console.stack"
    };
