 ...
 * @see prompt
 */
export function alert(alertText: string): void;
 ...
 * @see prompt
 */
export function confirm(strAlert: string): boolean;
 ...
 * @see confirm
 */
export function prompt(promptMsg: string, text?: string): string | null;
 ...
 * }
 */
export function configureTool(): void;
 ...
 * }
 */
export function mouseDoubleClick(): void;
 ...
 * }
 */
export function mouseDown(pt?: { x: number; y: number }): void;
 ...
 * }
 */
export function mouseMove(pt?: { x: number; y: number }): void;
