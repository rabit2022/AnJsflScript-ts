 ...
 */
import {FileURI, FoundObject} from "./flashType";
import {FlashMath} from "../Math/Math";
import {ActionsPanel} from "../actionsPanel/actionsPanel";
import {Element} from "../Element/Element";
import {Document} from "../Document/Document";
import {Tools} from "../Tools/Tools";
import {SWFPanel} from "../swfPanel/swfPanel";
import {SpriteSheetExporter} from "../SpriteSheetExporter/SpriteSheetExporter";
import {XMLUI} from "../XMLUI/XMLUI";
import {CompilerErrors} from "../compilerErrors/compilerErrors";
import {ComponentsPanel} from "../componentsPanel/componentsPanel";
import {DrawingLayer} from "../drawingLayer/drawingLayer";


export const fl: FlashObject;
// flash = fl = App = app = animate = an = new Flash();
export const flash: FlashObject;
export const App: FlashObject;
export const app: FlashObject;
export const animate: FlashObject;
export const an: FlashObject;
