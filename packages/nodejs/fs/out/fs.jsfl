...
function toFileURI(path) {
    ...
    if (lodash__WEBPACK_IMPORTED_MODULE_0__.startsWith(path, 'file:///')) {
        return path;
    }
...
function readdirSync(path, options) {
    ...
    if (!lodash__WEBPACK_IMPORTED_MODULE_0__.includes(attrs, 'D')) {
...
function statSync(path) {
    ...
    var attrs = FLfile.getAttributes(uri);
    var isDir = lodash__WEBPACK_IMPORTED_MODULE_0__.includes(attrs, 'D');
    return {
