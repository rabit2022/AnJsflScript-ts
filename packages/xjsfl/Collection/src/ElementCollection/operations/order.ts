...
export function orderBy(
    ...
    prop: "random" | OrderableProp | Comparator<FlashElement>,
    reverseOrder = false
) {
...
function createPropertyComparator(prop: OrderableProp): Comparator<FlashElement> {
    return (a, b) => {
...
function getOrderValue(element: FlashElement, prop: OrderableProp): number | string {
    switch (prop) {
        case "size":
