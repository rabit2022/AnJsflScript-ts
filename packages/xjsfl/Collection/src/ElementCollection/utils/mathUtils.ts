class Utils {
    ...
    static randomValue(a: [number, number], round?: boolean): number
    static randomValue(a: number, b: number, round?: boolean): number
    ...
    static randomizeValue(value: number, modifier?: number|string): number {
