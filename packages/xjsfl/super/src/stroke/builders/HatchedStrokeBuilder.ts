...
export class HatchedStrokeBuilder extends BaseStrokeBuilder<HatchedStroke> implements IHatchedStrokeBuilder {
    constructor() {
        super(new HatchedStroke());
    }

    public setCurve(curve: 'straight' | 'slight curve' | 'medium curve' | 'very curved'): this {
        this.stroke.curve = curve;
        return this;
    }

    public setHatchThickness(hatchThickness: 'hairline' | 'thin' | 'medium' | 'thick'): this {
    ...
    public setLength(length: 'equal' | 'slight variation' | 'medium variation' | 'random'): this {
