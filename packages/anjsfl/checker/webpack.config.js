...
// region MODULE_NAME
const MODULE_NAME = "@anjsfl/checker";
...
"lodash","linq","tslib","oxide.ts","requirejs","AnJsflScript-ts","micromatch","es8-shim","es7-shim","typedarray","symbol-es6","intl","harmony-reflect","es6-promise","es6-collections","json5","json3","@polyfill/symbol-dispose","jsbi","es10-shim","util","path-browserify","eventemitter3","seedrandom","random-js","chance","store-js","stackframe","error-stack-parser","progress","loglevel","cli-table3","chroma-js","@third/luxon","luxon","@third/date-fns","date-fns","_exports","es6-sham","es6-shim","@third/superjson","superjson","es5-sham","es5-shim","assert","@third/fast-xml-parser","fast-xml-parser","@third/universal-cookie","@polyfill/cookie","atob","base-64","Hello2","@xjsfl/UI","@xjsfl/super","@xjsfl/Selector","@xjsfl/Events","@xjsfl/Context","@xjsfl/Constants","@xjafl/Collection","overload-js","@nodejs/__filename","url","process","fs","child_process","@dom/setTimeout","console.table","console.stack","console","@anjsfl-ts/Tips","@anjsfl-ts/EditSession","@anjsfl-ts/dev","@anjsfl/validation","@anjsfl/sat","@anjsfl/random","@anjsfl/parser","@anjsfl/more-element","@xjsfl/XUL","@xjsfl/XUL/XML","@xjsfl/XUL/XUL","@xjsfl/XUL/XULControl","@xjsfl/XUL/XULEvent","@xjsfl/XUL/Utils","@xjsfl/XUL/xjsfl",
