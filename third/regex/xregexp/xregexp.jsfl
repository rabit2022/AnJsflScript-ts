            ...
            /***/ (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
                ...
                XRegExp.addToken = function (regex, handler, options) {
                    ...
                    if (optionalFlags) {
                        ...
                        for (var _i = 0, optionalFlags_1 = optionalFlags; _i < optionalFlags_1.length; _i++) {
                            var flag = optionalFlags_1[_i];
                            registerFlag(flag);
                        }
                    }
                ...
                XRegExp.escape = function (str) { return String(nullThrows(str)).
                    ...
                    replace(/[\s#\-,]/g, function (match) { return "\\u".concat(pad4(hex(match.charCodeAt(0)))); }); };
                /**
                 ...
                 */
                XRegExp.isRegExp = function (value) { return Object.prototype.toString.call(value) === '[object RegExp]'; };
                 ...
                 */
                XRegExp.matchChain = function (str, chain) { return (function recurseChain(values, level) {
                    ...
                    function addMatch(match) {
                        if (item.backref) {
                            ...
                            var backrefValue = isNamedBackref && XRegExp.isInstalled('namespacing') ?
                 ...
                 * // -> ['..', 'word', '1', '..']
                 */
                XRegExp.split = function (str, separator, limit) { return fixed.split.call(nullThrows(str), separator, limit); };
                /**
                ...
                /* harmony default export */ var xregexp = (XRegExp);
                 ...
                 */
                /* harmony default export */ var build = (function (XRegExp) {
                    var REGEX_DATA = 'xregexp';
                     ...
                     */
                    XRegExp.tag = function (flags) { return function (literals) {
                        var substitutions = [];
                 ...
                 */
                /* harmony default export */ var matchrecursive = (function (XRegExp) {
                    /**
                 ...
                 */
                /* harmony default export */ var unicode_base = (function (XRegExp) {
                    /**
                    ...
                    /\\([pP])(?:{(\^?)(?:(\w+)=)?([^}]*)}|([A-Za-z]))/, function (match, scope, flags) {
                        ...
                        var fullToken = match[0], pPrefix = match[1], caretNegation = match[2], typePrefix = match[3], tokenName = match[4], tokenSingleCharName = match[5];
                        // Negated via \P{..} or \p{^..}
                ...
                // EXTERNAL MODULE: ../../node_modules/.pnpm/xregexp@5.1.2/node_modules/xregexp/tools/output/categories.js
                var categories = __webpack_require__(48);
                 ...
                 */
                /* harmony default export */ var unicode_categories = (function (XRegExp) {
                    /**
                    ...
                    XRegExp.addUnicodeData((categories_default()));
                });
                // EXTERNAL MODULE: ../../node_modules/.pnpm/xregexp@5.1.2/node_modules/xregexp/tools/output/properties.js
                var properties = __webpack_require__(457);
                var properties_default = /*#__PURE__*/ __webpack_require__.n(properties);
                 ...
                 * Unicode data by Mathias Bynens <mathiasbynens.be>
                 */
                /* harmony default export */ var unicode_properties = (function (XRegExp) {
                    /**
                    ...
                    var unicodeData = (properties_default());
                ...
                // EXTERNAL MODULE: ../../node_modules/.pnpm/xregexp@5.1.2/node_modules/xregexp/tools/output/scripts.js
                var scripts = __webpack_require__(906);
                var scripts_default = /*#__PURE__*/ __webpack_require__.n(scripts);
                 ...
                 * Unicode data by Mathias Bynens <mathiasbynens.be>
                 */
                /* harmony default export */ var unicode_scripts = (function (XRegExp) {
                    /**
                    ...
                    XRegExp.addUnicodeData((scripts_default()), 'Script');
                });
                ; // ../../node_modules/.pnpm/xregexp@5.1.2/node_modules/xregexp/src/index.js
                build(xregexp);
                matchrecursive(xregexp);
                unicode_base(xregexp);
                unicode_categories(xregexp);
                unicode_properties(xregexp);
                unicode_scripts(xregexp);
                /* harmony default export */ var src = (xregexp);
                /***/ 
            }),
            /***/ 457: 
            /***/ (function (module) {
