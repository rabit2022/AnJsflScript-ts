...
var api = {
  ...
  let: { passes: "'use strict'; let a; " },
  const: { passes: "'use strict'; const b = 2;" },
  ...
  symbol: { passes: "'use strict'; var a = global.Symbol('b');" },
  symbolImplicitCoercion: { dependencies: ["symbol"], fails: "'use strict'; var a = global.Symbol('a'); a + '';" },
  ...
  letTDZ: { dependencies: ["let"], fails: "'use strict'; a = 1; let a;" },
  ...
  constRedef: { dependencies: ["const"], fails: "'use strict'; const a = 1; a = 2;" },
  ...
  NumberStatics: { is: "'use strict'; return ('isNaN' in global.Number) && ('isInteger' in global.Number);" },
