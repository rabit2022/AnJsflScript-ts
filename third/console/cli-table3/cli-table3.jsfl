...
(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) {
    ...
    o(t[i]); return o; } return r; })()({ 1: [function (require, module, exports) {
        ...
        }, { "call-bound": 9, "get-proto": 27, "has-tostringtag/shams": 33, "safe-regex-test": 52 }], 39: [function (require, module, exports) {
            'use strict';
            var callBound = require('call-bound');
            var hasToStringTag = require('has-tostringtag/shams')();
            var hasOwn = require('hasown');
        ...
        }, { "which-typed-array": 57 }], 41: [function (require, module, exports) {
            'use strict';
        ...
        }, { "call-bound": 9, "es-errors/type": 18, "is-regex": 39 }], 53: [function (require, module, exports) {
            'use strict';
            var GetIntrinsic = require('get-intrinsic');
        ...
        }, { "define-data-property": 10, "es-errors/type": 18, "get-intrinsic": 24, "gopd": 29, "has-property-descriptors": 30 }], 54: [function (require, module, exports) {
        ...
        }, { "is-arguments": 36, "is-generator-function": 38, "is-typed-array": 40, "which-typed-array": 57 }], 56: [function (require, module, exports) {
            (function (process) {
                (function () {
        ...
        }, { "./support/isBuffer": 54, "./support/types": 55, "_process": 51, "inherits": 35 }], 57: [function (require, module, exports) {
            (function (global) {
                (function () {
                    'use strict';
        ...
        }, { "available-typed-arrays": 1, "call-bind": 8, "call-bound": 9, "for-each": 21, "get-proto": 27, "gopd": 29, "has-tostringtag/shams": 33 }], 58: [function (require, module, exports) {
            var colors = {};
        ...
        }, { "./custom/trap": 59, "./custom/zalgo": 60, "./maps/america": 61, "./maps/rainbow": 62, "./maps/random": 63, "./maps/zebra": 64, "./styles": 65, "./system/supports-colors": 67, "util": 56 }], 59: [function (require, module, exports) {
        ...
        }, { "_process": 51 }], 67: [function (require, module, exports) {
            (function (process) {
                (function () {
                    'use strict';
                    var os = require('os');
        ...
        }, { "./has-flag.js": 66, "_process": 51, "os": 49 }], 68: [function (require, module, exports) {
            var colors = require('./lib/colors');
            module['exports'] = colors;
        }, { "./lib/colors": 58 }], 69: [function (require, module, exports) {
            module.exports = require('./src/table');
        }, { "./src/table": 77 }], 70: [function (require, module, exports) {
            'use strict';
            ...
            var stringWidth = function (string) {
        ...
        }, { "emoji-regex": 71, "is-fullwidth-code-point": 79, "strip-ansi": 73 }], 73: [function (require, module, exports) {
            'use strict';
            var ansiRegex = require('ansi-regex');
            module.exports = function (string) { return typeof string === 'string' ? string.replace(ansiRegex(), '') : string; };
        }, { "ansi-regex": 70 }], 74: [function (require, module, exports) {
            var _a = require('./debug'), info = _a.info, debug = _a.debug;
            ...
            var Cell = (function () {
                ...
                Cell.prototype.computeLines = function (tableOptions) {
                    var tableWordWrap = tableOptions.wordWrap || tableOptions.textWrap;
                    var _a = this.options.wordWrap, wordWrap = _a === void 0 ? tableWordWrap : _a;
                    if (this.fixedWidth && wordWrap) {
                        ...
                        var _b = tableOptions.wrapOnWordBoundary, tableWrapOnWordBoundary = _b === void 0 ? true : _b;
                        var _c = this.options.wrapOnWordBoundary, wrapOnWordBoundary = _c === void 0 ? tableWrapOnWordBoundary : _c;
                        return this.wrapLines(utils.wordWrap(this.fixedWidth, this.content, wrapOnWordBoundary));
                    }
                    return this.wrapLines(this.content.split('\n'));
                };
                Cell.prototype.wrapLines = function (computedLines) {
                    var _this = this;
                    var lines = utils.colorizeLines(computedLines);
                    if (this.href) {
                        return lines.map(function (line) { return utils.hyperlink(_this.href, line); });
                    }
                    return lines;
                };
            ...
            var ColSpanCell = (function () {
                ...
                ColSpanCell.prototype.draw = function (lineNum) {
                    if (typeof lineNum === 'number') {
                        debug("".concat(this.y, "-").concat(this.x, ": 1x1 ColSpanCell"));
                    }
                    return '';
                };
                ColSpanCell.prototype.init = function () { };
            ...
            function firstDefined() {
                ...
                return args.filter(function (v) { return v !== undefined && v !== null; }).shift();
            }
        ...
        }, { "./debug": 75, "./utils": 78, "@colors/colors/safe": 68 }], 75: [function (require, module, exports) {
            var messages = [];
            var level = 0;
            var debug = function (msg, min) {
                if (level >= min) {
                    messages.push(msg);
                }
            };
            ...
            debug.warn = function (msg) { return debug(msg, debug.WARN); };
            debug.info = function (msg) { return debug(msg, debug.INFO); };
            debug.debug = function (msg) { return debug(msg, debug.DEBUG); };
            debug.debugMessages = function () { return messages; };
            module.exports = debug;
        }, {}], 76: [function (require, module, exports) {
            var _a = require('./debug'), warn = _a.warn, debug = _a.debug;
            var Cell = require('./cell');
            var ColSpanCell = Cell.ColSpanCell, RowSpanCell = Cell.RowSpanCell;
            (function () {
        ...
        }, { "./cell": 74, "./debug": 75 }], 77: [function (require, module, exports) {
                ...
                function Table(opts) {
                    ...
                    if (options.debug) {
                        switch (typeof options.debug) {
                            ...
                            default:
                                debug.setDebugLevel(debug.WARN);
                                debug.warn("Debug option is expected to be boolean, number, or string. Received a ".concat(typeof options.debug));
                        }
            ...
            Table.reset = function () { return debug.reset(); };
        ...
        }, { "./debug": 75, "./layout-manager": 76, "./utils": 78 }], 78: [function (require, module, exports) {
            ...
            function multiLineWordWrap(maxLength, input, wrapOnWordBoundary) {
                if (wrapOnWordBoundary === void 0) { wrapOnWordBoundary = true; }
                var output = [];
                input = input.split('\n');
        ...
        }, { "string-width": 72 }], 79: [function (require, module, exports) {
            'use strict';
            var isFullwidthCodePoint = function (codePoint) {
